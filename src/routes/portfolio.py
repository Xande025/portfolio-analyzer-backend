    ...
    try:
        ...
        for asset in assets:
            ...
            if asset_type == 'stock':
                ...
                # Implementar busca de criptomoedas se necessário
                # Por simplicidade, vamos pular por agora
                pass
        
        if not all_prices:
            return jsonify({'error': 'No valid price data found'}), 400
